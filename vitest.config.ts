...
export default defineConfig({
  resolve: {
    alias: [
      ...
      {
        find: /^#types\/(box-style|detection-timeline|detections|editing|focus-style|interaction|interaction-style|keypoint-style|label-style|mask-style|media|media-rendering|polygon-style|polyline-style|session-lifecycle|shape-style|style|viewport)$/,
