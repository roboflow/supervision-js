      ...
      >
        <SegmentedControl
          ...
          options={[
            ...
            { label: "Triangle", value: DemoBoxAnnotator.Triangle },
        ...
        {settings.boxAnnotator === DemoBoxAnnotator.Triangle && (
          <SliderControl
            ...
            max={32}
            min={6}
            onChange={(value) => onChange("boxTriangleSize", value)}
            step={1}
            value={settings.boxTriangleSize}
            valueLabel={`${settings.boxTriangleSize}px`}
          />
        )}
